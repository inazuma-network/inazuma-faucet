...
This repository holds the faucet service that hands out test INAZ. Contributions are welcome, including your first one.
...
## Setting up
        ...
        ```bash
        git clone https://github.com/inazuma-network/inazuma-faucet.git
        cd inazuma-faucet
